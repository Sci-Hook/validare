...
var replacer_1 = require("../../functions/replacer");
function replace(schema, values, options) {
    var _this = this;
    return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    value_array = _a.sent();
                    return [4 /*yield*/, (0, get_value_1.get_value)(req, res, schema)];
                case 2:
                    data = _a.sent();
                    return [4 /*yield*/, (0, replacer_1.replacer)(value_array, data)];
                case 3:
                    _a.sent();
                    data.save();
                    next();
