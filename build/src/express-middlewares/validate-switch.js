...
function validateSwitch(dataname, switches, callback) {
    var _this = this;
    return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
        var data, fields, invalid_values;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, get_value_1.get_value)(dataname, req, res)];
                case 1:
                    data = _a.sent();
                    if (data === undefined || data === null) {
                        return [2 /*return*/];
                    }
                    fields = switches[data] ? switches[data] : (switches['$default'] ? switches['$default'] : []);
                    invalid_values = [];
