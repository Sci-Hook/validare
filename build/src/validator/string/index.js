...
var check_length_1 = require("../funcs/check-length");
function validate_string(schema, value) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var splitted, flag, pattern, regex, status;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, check_length_1.check_length)(schema, value)];
                case 1:
                    status = _a.sent();
                    if (status != 'no_error') {
                        return [2 /*return*/, resolve(new error_1.Status(status))];
                    }
                    return [2 /*return*/, resolve(new error_1.Status('no_error'))];
            }
        });
    }); });
}
